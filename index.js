...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendMessage(msg.chat.id,
        "ПРАВИЛА 📝\n" +
        "умовами проходження віпасани \n" +
        "\n\n" +
        "Реєстрація на ретрит в різних форматах 👇🏻\n" +
        "Оберіть один з варіантів нижче:",
        {
            reply_markup: {
                inline_keyboard: [
                    [
                        { text: "1️⃣ РЕТРИТ КАРПАТИ", callback_data: "option_1" }
                    ],
                    [
                        { text: "2️⃣ СЛУЖІННЯ НА РЕТРИТІ", callback_data: "option_2" }
                    ],
                    [
                        { text: "3️⃣ ОНЛАЙН РЕТРИТ", callback_data: "option_3" }
                    ],
                    [
                        { text: "4️⃣ ДОНАТ", callback_data: "option_4" }
                    ]
                ]
            }
        }
